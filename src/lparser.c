...
static void localstat(LexState* ls) {
    ...
    Vardesc* var = 0;  /* last variable */
    int vidx = 0, kind = 0;  /* index and kind of last variable */
    int nvars = 0;
    int nexps = 0;
    expdesc e = { 0 };
    do {
...
static void retstat(LexState* ls) {
    ...
    FuncState* fs = ls->fs;
    expdesc e = { 0 };
    int nret = 0;  /* number of values being returned */
